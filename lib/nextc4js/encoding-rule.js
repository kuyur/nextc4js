 ...
 * @extends {EncodingRule}
 */
var Doublebyte = function() {
  EncodingRule.call(this);
};
goog.inherits(Doublebyte, EncodingRule);
...
goog.inherits(Gb18030, EncodingRule);

exports.EncodingRule = EncodingRule;
