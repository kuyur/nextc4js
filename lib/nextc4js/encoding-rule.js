...
/**
 * Encoding the UTF-16 code points.
 * @param {Uint32Array|Array.<number>} buffer Every element must be a UTF-16
 *   code points.
 * @return {Uint8Array}
 */
EncodingRule.prototype.unparse = function(buffer) {
...
/**
 * Consume(unparse) a UTF-16 code point from source buffer and save into
 * result buffer. Won't check the bytes strictly.
 * @protected
 * @param {Uint32Array|Array.<number>} buffer The source buffer holding UTF-16
 *   code points.
 * @param {number} pos The position (pointer) to read next UTF-16 code point.
...
/**
 * The invalid UTF-16 code point will be skipped.
 * @override
 * @param {Uint32Array|Array.<number>} buffer
 * @return {number} The length of encoded bytes.
 */
...
/**
 * The invalid UTF-16 code point will be ignored.
 * @override
 * @param {Uint32Array|Array.<number>} buffer
 * @return {number} The length of encoded bytes.
 */
