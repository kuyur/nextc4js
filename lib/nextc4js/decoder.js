 ...
 * @return {Uint32Array}
 */
Decoder.prototype.convert = goog.abstractMethod;
 ...
 * @return {Uint32Array}
 */
DecoderUtf16le.prototype.convert = function(buffer) {
 ...
 * @return {Uint32Array}
 */
DecoderUtf16be.prototype.convert = function(buffer) {
  return this.rule_.decode(buffer);
};
 ...
 * @return {Uint32Array}
 */
DecoderUtf8.prototype.convert = function(buffer) {
  return this.rule_.decode(buffer);
};
 ...
 * @return {Uint32Array}
 */
DecoderMultibyte.prototype.convert = function(buffer) {
  var decoded = this.rule_.decode(buffer);
  if (!decoded) {
    return null;
  }
