...
var DECODING_RULE_UTF16LE = require('./decoding-rule.js').DECODING_RULE_UTF16LE;
var DECODING_RULE_UTF16BE = require('./decoding-rule.js').DECODING_RULE_UTF16BE;
var DECODING_RULE_UTF8 = require('./decoding-rule.js').DECODING_RULE_UTF8;
var DecodingRuleMultibyte = require('./decoding-rule.js').DecodingRuleMultibyte;
var gb18030utils = require('./gb18030.js').gb18030utils;
 ...
 * @extends {Charmap}
 */
var CharmapFront = function(name) {
  Charmap.call(this, name, CharmapType.FRONT_END);
};
...
var CharmapFrontUtf16le = function() {
  CharmapFront.call(this, 'UTF-16 (little-endian)');
...
var CharmapFrontUtf16be = function() {
  CharmapFront.call(this, 'UTF-16 (big-endian)');
...
var CharmapFrontMultibyte = function(options, mappingBuffer) {
  ...
  CharmapFront.call(this, options['name']);
...
CharmapFrontMultibyte.prototype.convertChar_ = function(chr) {
  ...
  case SegmentReference.BUFFER:
    ...
    return this.mappingBuffer_[chr - segment.getBegin() + segment.getOffset()];
  case SegmentReference.INDEXING_BUFFER:
    ...
    return this.mappingBuffer_[offset + segment.getOffset()];
