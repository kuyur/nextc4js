 ...
 * @return {number}
 */
DecodingRuleUTF16LE.prototype.consume = function(buffer, i, result, j) {
 ...
 * @return {number}
 */
DecodingRuleUTF16LE.prototype.consume2 = function(buffer, length, i, result, j) {
 ...
 * @return {number}
 */
DecodingRuleUTF16BE.prototype.consume = function(buffer, i, result, j) {
 ...
 * @return {number}
 */
DecodingRuleUTF16BE.prototype.consume2 = function(buffer, length, i, result, j) {
  if (i + 1 >= length) { // invalid
    return 0;
  }
 ...
 * @return {number}
 */
DecodingRuleUTF8.prototype.consume = function(buffer, length, i, result, j) {
  if ((0x80 & buffer[i]) === 0) { // ASCII
    result[j] = buffer[i];
    return 1;
 ...
 * @return {number}
 */
DecodingRuleUTF8.prototype.consume2 = function(buffer, length, i, result, j) {
  if ((0x80 & buffer[i]) === 0) { // ASCII
    result[j] = buffer[i];
    return 1;
  } else if (i + 1 < length &&
