 ...
 *   the decoding rule.
 */
DecodingRule.prototype.decode = function(buffer) {
 ...
 * @extends {DecodingRule}
 */
var Multibyte = function(options) {
  DecodingRule.call(this);
...
goog.inherits(Multibyte, DecodingRule);

/**
 * @private
 * @type {Array.<condition.Condition>}
 */
Multibyte.prototype.conditions_;
 ...
 * @return {number} The count of code points.
 */
Multibyte.prototype.test = function(buffer) {
 ...
 */
Multibyte.prototype.find_ = function(buffer, offset) {
 ...
 * @return {number}
 */
Multibyte.prototype.consume = function (buffer, offset, result, pos) {
 ...
 * @return {number}
 */
Multibyte.prototype.readUInt32BE_ = function(buffer, offset, bytes) {
  var result = 0;
 ...
 * @return {number}
 */
Multibyte.prototype.consume2 = Multibyte.prototype.consume;

exports.DecodingRule = DecodingRule;
exports.Multibyte = Multibyte;
